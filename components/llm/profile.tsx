...
export const Profile = () => {
    ...
    return (
        <div className="h-auto w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto -mt-12">
            <div className="p-4 relative z-10 w-full text-center md:mb-0 mb-64">
                <div className="flex items-center justify-around flex-col-reverse w-full m-auto">
                    <div className="w-full flex items-start flex-col gap-1 mt-28">
                        ...
                        <p className="md:text-4xl text-2xl font-bold text-start w-[500px]">
                        ...
                        <div className="mt-8 w-[300px] flex items-center justify-between">
                            ...
                            <button className={`border-2 text-sm font-medium relative text-black dark:text-white px-2 py-2 rounded-full transition-all ${hover ? "border-blue-500" : "dark:border-white/[0.2]"}`}>
                                <Link href={"https://github.com/arit98"} target="_blank"><IconBrandGithub color="#3A77DB" /></Link>
                            </button>
                            <button className={`border-2 text-sm font-medium relative text-black dark:text-white px-2 py-2 rounded-full transition-all ${hover ? "border-blue-500" : "dark:border-white/[0.2]"}`}>
                                <Link href={"https://www.linkedin.com/in/aritra-das-chowdhury-802839140"} target="_blank"><IconBrandLinkedin color="#3A77DB" /></Link>
                            </button>
                        </div>
                    </div>
                    <div>
